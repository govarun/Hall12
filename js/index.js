...
function messing(n) {
    ...
    let a;
    if (n == 0) {//sunday
        a = "MASALA IDLI, SAMBHAR # VEG TAKATAK, MASOOR DAL EXTRA- VEG AWADHI BIRYANI/EGG BIRIYANI # GHOBHI MUSALLAM, MOONG DAL, NAAN ,ROTI, CHHENA, MISSI ROTI,SALAD MIX EXTRA – KESARIYA MILK";
    } else if (n == 1) {//monday and so on...
        a = "WADA PAV WITH CHUTNEY # ARHAR DAL, ALOO PATTAGOBHI (CABBAGE) ,FRIMES, EXTRA – EGG CURRY,VEG KAWAB # METHI PARATHA,CHANA DAL ,DUM ALOO EXTRA – CHIKEN BUTTER MASALA,SWEET- RASMALAI, PANEER TIKKA";
    } else if (n == 2) {
        a = "PYAZ  KACHORI # MIXVEG,ARHAR DAL EXTRA- DAHI WADA,SWEET- CHHENA SANDWICH # CHOLE, BHATURE/KULCHA, RICE,CUSTARD EXTRA – ROASTED CHIKEN,CHAT:- (ALOO TIKKI/ PAPDI)";
    } else if (n == 3) {
        a = "CHANA ,HALWA,POORI/ PAV BHAJI # ALOO JEERA,MASALA KADI WITH PAKODI,PAPAD EXTRA- CHILLY PANEER,MOONG HALWA # BESAN GATTA ,LAL MASOOR DAL,MISSI ,NAAN ROTI EXTRA-CHICKEN KALIMIRCH ,IMARTY RABIDI, PAKODI MIX";
    } else if (n == 4) {
        a = "UTTAPAM WITH SAMBHAR AND CHUTNEY # ALOO GOBHI MATAR, RAJMA, BOONDI RAITA # ALOO TOMATO MOTOR,ARHAR DAL,LEMON RICE EXTRA- CHICKEN ROASTED,SWEET";
    } else if (n == 5) {
        a = "POHA, JALEBI, CURD # PARATHA-PANEER/ALOO/MIX VEG, CHUTNEY, CHHOLE ~ EXTRA- SWEET-CHHENA TIKIA # pALAK PANEER,JEERA RICE,ARHAR DAL,PLAIN PARATHA , SOUP EXTra –RASGOLA, CHICKEN BIRYANI, GAJAR HALWA";
    } else if (n == 6) {
        a = "DOSA, SAMBHAR, COCONUT CHUTNEY # DAL MAKHANI, ALOO METHI ,MIX RAITA EXTRA- PANEER KHURCHAN, BUTTER CHAMCHAM # PINDI CHHOLA ,POORI,MIX DAL,SEVAI/KHEER ~ EXTRA – CHIKEN CURRY, CRISPY VEG";
    }
    let bbbb = a.split('#');
